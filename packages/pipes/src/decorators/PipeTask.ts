...
import { PipeActivityBuilderToken } from '../core/IPipeActivity';
 ...
 * @PipeTask
 */
export const PipeTask: ITaskDecorator<PipeTaskMetadata> = createTaskDecorator<PipeTaskMetadata>('PipeTask',  PipeActivityBuilderToken);
