...
import { AssetConfigure, AssetBuilderToken } from '../core/AssetConfigure';
 ...
 * @AssetTask
 */
export const AssetTask: ITaskDecorator<AssetTaskMetadata> = createTaskDecorator<AssetTaskMetadata>('AssetTask', AssetBuilderToken);
